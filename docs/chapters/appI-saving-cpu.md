...
Bekker 等人[[725]](references.md#ref-725) 为具有周期性边界条件的系统开发了一种优雅的 Verlet 列表扩展[[725]](references.md#ref-725)。要计算粒子$i$的力或势能，必须定位粒子$j$的 Verlet 列表中粒子的最近镜像（见算法 30）。Bekker 等人证明，在 MD 或 MC 模拟的内循环中可以避免这种最近镜像计算。
