...
在第8.5.3节中，我们将讨论即使系统的哈密顿量以有限速率变化时，
如何仍然可以计算自由能差。
...
一种广泛使用的获取态密度的蒙特卡罗方案由Wang和Landau引入（见第8.6.3节）。随后，我们将讨论重建任意自由能面的更近期技术。然而，出于教学原因，我们首先讨论偏倚采样的最早系统实例，即Torrie和Valleau^[347]的所谓伞形采样方法。
