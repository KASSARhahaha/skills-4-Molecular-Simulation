...
*图 D.1　在不改变任一体系能量的前提下，将粒子从温度为 $T_1$ 的体系 1 转移到温度为 $T_2$ 的体系 2，这要求每个粒子把全部能量（甚至动能）都留在体系 1 中，并以消耗体系 2 的能量为代价获得其新的能量。（图内标注：牌子上的英文为“T1-T2 border. No energy may be transported across the border.”（$T_1$–$T_2$ 边界，任何能量都不得越过此边界）与“Pure Energy 10 kcal”（纯能量 10 kcal））*
